 ...
 */
Ext.define('Form.view.reminder.Month', {
    ...
    initDD: function() {
        ...
        this.dragZone = new Form.view.reminder.dd.DragZone(this.el, cfg);
        this.dropZone = new Form.view.reminder.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new Form.view.reminder.template.Month({
                id: this.id,
    ...
    renderItems: function() {
        Form.view.reminder.util.WeekEventRenderer.render({
    ...
    getDayAt: function(x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = Form.view.reminder.util.Date.add(this.viewStart, {days: days});
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onClick: function(e, t) {
        ...
        if (Form.view.reminder.Month.superclass.onClick.apply(this, arguments)) {
