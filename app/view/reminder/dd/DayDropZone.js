 ...
 */
Ext.define('Form.view.reminder.dd.DayDropZone', {
    extend: 'Form.view.reminder.dd.DropZone',
    /**
    requires: [
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = Form.view.reminder.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = Form.view.reminder.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || Form.view.reminder.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = Form.view.reminder.util.Date.copyTime(n.date, this.resizeDt);
                start = Form.view.reminder.util.Date.min(data.eventStart, curr);
                end = Form.view.reminder.util.Date.max(data.eventStart, curr);
