 ...
 */
Ext.define('Form.view.reminder.dd.DragZone', {
    ...
    **/
    ...
    constructor: function(el, config) {
        if (!Form.view.reminder._statusProxyInstance) {
            Form.view.reminder._statusProxyInstance = new Form.view.reminder.dd.StatusProxy();
        }
        this.proxy = Form.view.reminder._statusProxyInstance;
