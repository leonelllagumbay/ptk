 ...
 */
Ext.define('Form.view.reminder.dd.DropZone', {
	...
	**/
    ...
    shim: function(start, end) {
        ...
        var dt = Ext.Date.clone(start),
            ...
            shim,
            box,
            D = Form.view.reminder.util.Date,
    ...
    onNodeDrop: function(n, dd, e, data) {
        if (n && data) {
            if (data.type == 'eventdrag') {
                ...
                dt = Form.view.reminder.util.Date.copyTime(rec.data[Form.model.reminder.EventMappings.getFields()[0].StartDate.name], n.date);
