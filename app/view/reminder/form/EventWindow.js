 ...
 */
Ext.define('Form.view.reminder.form.EventWindow', {
    ...
    afterRender: function() {
    	console.log('On after render window');
        this.callParent();
    ...
    onEditDetailsClick: function(e){
    	console.log('On edit details click window');
        e.stopEvent();
    ...
    show: function(o, animateTarget) {
        ...
        if (o.data) {
            ...
            var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || Form.view.reminder.util.Date.add(start, {hours: 1});

            rec = Ext.create('Form.model.reminder.EventModel');
            rec.data[M.StartDate.name] = start;
            rec.data[M.EndDate.name] = end;
            rec.data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != Form.view.reminder.util.Date.add(end, {millis: 1}).getDate();
    ...
    // private
    onSave: function(){
    	console.log('On save window');
        if(!this.formPanel.form.isValid()){
        	return;
        }
        if(!this.updateRecord(this.activeRecord)){
            this.onCancel();
            console.log('not update record');
            return;
        }
        ...
        if(this.activeRecord.phantom) {
        	...
        	this.fireEvent('eventupdate', this, this.activeRecord, this.animateTarget);
        }
