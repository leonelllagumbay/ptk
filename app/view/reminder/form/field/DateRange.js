 ...
 */
Ext.define('Form.view.reminder.form.field.DateRange', {
     ...
     */
    getValue: function(){
        var eDate = Form.view.reminder.util.Date,
    ...
    setValue: function(v){
        ...
        else if(v[Form.model.reminder.EventMappings.getFields()[0].StartDate.name]){ //object
            this.setDT(v[Form.model.reminder.EventMappings.getFields()[0].StartDate.name], 'start');
            if(!this.setDT(v[Form.model.reminder.EventMappings.getFields()[0].EndDate.name], 'end')){
                this.setDT(v[Form.model.reminder.EventMappings.getFields()[0].StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[Form.model.reminder.EventMappings.getFields()[0].IsAllDay.name]);
        }
    },
