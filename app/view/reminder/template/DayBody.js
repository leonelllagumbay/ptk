 ...
 */
Ext.define('Form.view.reminder.template.DayBody', {
    ...
    applyTemplate : function(o){
        this.today = Form.view.reminder.util.Date.today();
        ...
        for(; i<this.dayCount; i++){
            days[i] = Form.view.reminder.util.Date.add(dt, {days: i});
        }
        ...
        for(i=0; i<24; i++){
            ...
            dt = Form.view.reminder.util.Date.add(dt, {hours: 1});
        }
