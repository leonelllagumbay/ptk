...
<cfset countAll = ORMExecuteQuery("FROM EGRGQUERY #PreserveSingleQuotes(WHERE)#" )>
...
<cfset countAll = ORMExecuteQuery("FROM EGRGEVIEWFIELDS #PreserveSingleQuotes(whereb)#" )>
