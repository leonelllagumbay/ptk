...
<cfloop query="qryCIN21POSITNAPLD1">
	...
	<cfset POSITIONFIRSTPRIORITY   = '#POSITIONAPPLIEDFOR#'>
    
    <cfquery name="getcompanydes1" datasource="#session.company_dsn#" maxrows="1">
        SELECT DESCRIPTION, COMPANYCODE  FROM CLKCOMPANY
...
<cfloop query="qryCIN21POSITNAPLD2">
	...
	<cfset POSITIONSECONDPRIORITY   = '#POSITIONAPPLIEDFOR#'>
...
<cfloop query="qryCIN21POSITNAPLD3">
	...
	<cfset POSITIONTHIRDPRIORITY   = '#POSITIONAPPLIEDFOR#'>
...
<cfquery name="qryCIN21FAMILYBKGRNDSD" datasource="#session.company_dsn#"> 
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
...
<cfloop query="qryCIN21FAMILYBKGRNDSD">
...
<cfquery name="qryCIN21FAMILYBKGRNDBS" datasource="#session.company_dsn#"> 
		   SELECT   GUID,
                    PERSONNELIDNO,
                    NAME,
                    AGE,
...
<cfloop query="qryCIN21FAMILYBKGRNDBS">
...
<cfquery name="geteducfield" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION  
      FROM GLKDEGREE
     WHERE DEGREECODE = '#qryCIN21EDUCATIONP.MAJORDEGREE#';
</cfquery>
...
<cfquery name="geteducfield" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION  
      FROM GLKDEGREE
     WHERE DEGREECODE = '#qryCIN21EDUCATIONC.MAJORDEGREE#';
</cfquery>
...
<cfquery name="geteducfield" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION  
      FROM GLKDEGREE
     WHERE DEGREECODE = '#qryCIN21EDUCATIONV.MAJORDEGREE#';
</cfquery>
...
<cfquery name="geteducfield" datasource="#session.global_dsn#" maxrows="1">
    SELECT DESCRIPTION  
      FROM GLKDEGREE
     WHERE DEGREECODE = '#qryCIN21EDUCATIONS.MAJORDEGREE#';
</cfquery>
...
<cfquery name="qryCIN21ACHIEVEMENTSB" datasource="#session.company_dsn#" maxrows="1"> 
		   SELECT   GUID,
                    PERSONNELIDNO,
                    AWARDTITLE,
                    DATEGIVEN,
			...
			WHERE   GUID = '#theguid#' AND AWARDTITLE LIKE '%BOARD%';
</cfquery>

<cfloop query="qryCIN21ACHIEVEMENTSB">
					
	<cfset BOARDEXAMRESULT = '#NATURECATEGORY#'>
    
</cfloop>

<cfquery name="qryCIN21ACHIEVEMENTSL" datasource="#session.company_dsn#" maxrows="1"> 
		   SELECT   GUID,
                    PERSONNELIDNO,
                    AWARDTITLE,
                    DATEGIVEN,
                    NATURECATEGORY	
			 FROM   CIN21ACHIEVEMENTS
			WHERE   GUID = '#theguid#' AND AWARDTITLE LIKE '%LICENSE%';
</cfquery>

<cfloop query="qryCIN21ACHIEVEMENTSL">
...
<cfquery name="qryCIN21EMPVIOL1" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   PERSONNELIDNO,
                   CASENUMBER,
                   CASENAME,
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%defects%';
</cfquery>

<cfloop query="qryCIN21EMPVIOL1">
...
<cfquery name="qryCIN21EMPVIOL2" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   ...
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%illness%';
</cfquery>
...
<cfquery name="qryCIN21EMPVIOL3" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   ...
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%sensitive%';
</cfquery>
...
<cfquery name="qryCIN21EMPVIOL4" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   ...
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%dangerous drugs%';
</cfquery>
...
<cfquery name="qryCIN21EMPVIOL5" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   ...
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%business%';
</cfquery>
...
<cfquery name="qryCIN21EMPVIOLN6" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   ...
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%suspended%';
</cfquery>
...
<cfquery name="qryCIN21EMPVIOL7" datasource="#session.company_dsn#"> 
		   SELECT  GUID,
                   ...
                   CASESTATUS
			 FROM  CIN21EMPVIOL
			WHERE  GUID = '#theguid#' AND CASENUMBER LIKE '%convicted%';
</cfquery>
